...
cur = mydb.cursor()
cur.execute("SELECT  new_attr_name,new_attr_value,model_no,entity_id,l3_name,id,value1 FROM `58_l3_update_new_value` WHERE id>589810 AND new_attr_name !='Thread Size' AND value1 LIKE '%/%'  ")
